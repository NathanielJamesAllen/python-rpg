...
class Combat():
    ...
    def are_all_characters_dead(self, characters):
        dead_characters = []
    ...
    def is_combat_over(self):
        ...
        if self.are_all_characters_dead(self.player_characters) or self.are_all_characters_dead(self.non_player_characters):
            return True
        else:
            return False

    def end_combat(self):
        if not self.are_all_characters_dead(self.player_characters):
    ...
    def turn(self):
        ...
        for attacker in self.ordered_combatants:
            #2 choose attacker and defender
